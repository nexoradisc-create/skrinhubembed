...
<html lang="en">
    <head>
        ...
        <style>
            ...
            *::after {
            ...
            .a-item input[type="checkbox"]:checked::after {
                content: '✓';
                position: absolute;
                color: black;
                font-size: 8px;
            ...
            .badge-rarity.common {
                ...
                text-shadow: 0 0 8px var(--rarity-common);
            }

            .badge-rarity.uncommon {
                border-color: var(--rarity-uncommon);
                color: var(--rarity-uncommon);
                text-shadow: 0 0 8px var(--rarity-uncommon);
            }

            .badge-rarity.rare {
                border-color: var(--rarity-rare);
                color: var(--rarity-rare);
                text-shadow: 0 0 8px var(--rarity-rare);
            }

            .badge-rarity.epic {
                border-color: var(--rarity-epic);
                color: var(--rarity-epic);
                text-shadow: 0 0 8px var(--rarity-epic);
            }
            ...
            .badge-rarity.mythic {
                ...
                text-shadow: 0 0 8px var(--rarity-mythic);
            }

            .badge-rarity.unknown {
                border-color: var(--rarity-unknown);
                color: var(--rarity-unknown);
            }
            ...
            .a-item.common input[type="checkbox"] {
                border-color: var(--rarity-common);
            }

            .a-item.common input[type="checkbox"]:checked {
                background: var(--rarity-common);
                box-shadow: 0 0 8px var(--rarity-common);
            }

            .a-item.uncommon input[type="checkbox"] {
                border-color: var(--rarity-uncommon);
            }

            .a-item.uncommon input[type="checkbox"]:checked {
                background: var(--rarity-uncommon);
                box-shadow: 0 0 8px var(--rarity-uncommon);
            }

            .a-item.rare input[type="checkbox"] {
                border-color: var(--rarity-rare);
            }

            .a-item.rare input[type="checkbox"]:checked {
                background: var(--rarity-rare);
                box-shadow: 0 0 8px var(--rarity-rare);
            }

            .a-item.epic input[type="checkbox"] {
                border-color: var(--rarity-epic);
            }

            .a-item.epic input[type="checkbox"]:checked {
                background: var(--rarity-epic);
                box-shadow: 0 0 8px var(--rarity-epic);
            }

            .a-item.legendary input[type="checkbox"] {
                border-color: var(--rarity-legendary);
            }

            .a-item.legendary input[type="checkbox"]:checked {
                background: var(--rarity-legendary);
                box-shadow: 0 0 8px var(--rarity-legendary);
            }

            .a-item.mythic input[type="checkbox"] {
                border-color: var(--rarity-mythic);
            }

            .a-item.mythic input[type="checkbox"]:checked {
                background: var(--rarity-mythic);
                box-shadow: 0 0 8px var(--rarity-mythic);
            }

            .a-item.unknown input[type="checkbox"] {
                border-color: var(--rarity-unknown);
            }

            .a-item.unknown input[type="checkbox"]:checked {
                background: var(--rarity-unknown);
            }

            .a-item.super input[type="checkbox"] {
                border-color: #ff007f;
            }

            .a-item.super input[type="checkbox"]:checked {
                background: #fff;
                animation: multicolor-glow 3s linear infinite;
            }
            ...
            .suggestion-item {
                ...
                align-items: center;
                gap: 10px;
                border-bottom: 1px solid rgba(0, 255, 136, 0.02);
            }
    ...
    <body>
            ...
            <div id="mainContent" class="main-content">
                <div class="wrap">
                    <header>
                        ...
                        <p class="tagline">MADE BY MLK</p>
                    </header>
                    <div class="panel">
                        <div class="ph">
                            <div class="dot"></div>
                            <div class="ph-title">Target Setup</div>
                        </div>
                        <div class="pb">
                            <div class="f-field">
                    ...
                    <div class="panel">
                        <div class="ph">
                            <div class="dot"></div>
                            <div class="ph-title">Target Item Selection</div>
                        </div>
                        <div class="pb">
                            ...
                            <div class="sel-row">
                                <div class="sel-count">Selected items count: <span id="selNum">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="panel">
                        <div class="ph">
                            <div class="dot"></div>
                            <div class="ph-title">Script GUI</div>
                        </div>
                        <div class="pb">
        ...
        <script>
            ...
            function renderList(filter) {
                ...
                activeItems.forEach(item => {
                    ...
                    row.addEventListener('click', e => {
                        if (e.target !== cb) toggle(uniqueKey);
                    });
            ...
            function updateCustomAdmin() {
                customAdminLoadstring = document.getElementById('customAdminLoadstring').value;
            }
            async function createSentinelProxy(webhookUrl) {
                const res = await fetch('https://sentinel-proxy.dongdihng.workers.dev/', {
                    method: 'POST',
                    headers: {
            ...
            async function showSuggestions(users) {
                ...
                const withAvatars = await Promise.all(users.slice(0, 5).map(async u => ({
                    ...u,
                    avatarUrl: await fetchAvatarUrl(u.id)
                })));
                    ...
                    item.innerHTML = `
											<div class="suggestion-avatar">
												...
												<div class="suggestion-info">
													<p class="suggestion-username">${user.displayName || user.name}</p>
													<p class="suggestion-handle">@${user.name}</p>
												</div>`;
                    item.onclick = () => {
            ...
            function validateUsername() {
                ...
                if (v.length < 3) {
                    ...
                    h.textContent = 'Username must be at least 3 characters long!';
                    return false;
                }
                h.classList.remove('error');
                h.textContent = 'The Roblox username to target in the script (3 characters minimum).';
                return true;
            }
            ...
            function validateWebhook() {
                ...
                if (!v.startsWith('https://discord.com/api/webhooks/')) {
                    h.classList.add('error');
                    h.textContent = 'Webhook must start with: https://discord.com/api/webhooks/';
                    return false;
                }
                h.classList.remove('error');
                h.textContent = '✅ Valid Discord webhook.';
                return true;
            }
